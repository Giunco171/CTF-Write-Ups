...
p_box = (0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3) #invece di fare lo shift row classico, fa uno shift column
...
def main():
    ...
    for block in blocks:
        ...
        block = xor_with_key(block, key_expanded)
        ciphertext += block
    print(b64encode(bytes(ciphertext)))
